...
echo -e "\033[0;36m   BlueFalcon Website Maker - One-Click Initializer         \033[0m"
echo -e "\033[0;36m=================================================\033[0m"
...
rm -rf bluefalcon-website-maker
git clone https://github.com/bluefalcon2270/bluefalcon-website-maker.git

echo -e "\033[1;33mStep 3: Launching Interactive Menu...\033[0m"
cd bluefalcon-website-maker
bash install.sh
